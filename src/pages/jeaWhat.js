      ...
      <div className="container-fluid  py-5">
        ...
        <div className="cards card-body">
            ...
            >
              ...
              <h3 className="display-7 fw-bold ">Jealousy generally refers to the thoughts or feelings of insecurity, fear, and concern over a relative lack of possessions or safety. It is a typical experience in human relationships, and it has been observed in infants as young as five months. Some researchers claim that jealousy is seen in all cultures and is a universal trait. 
                 Jealousy can either be suspicious or reactive, and it is often reinforced as a series of particularly strong emotions and constructed as a universal human experience. Psychologists have proposed several models to study the processes underlying jealousy and have identified factors that result in jealousy. Sociologists have demonstrated that cultural beliefs and values play an important role in determining what triggers jealousy and what constitutes socially acceptable expressions of jealousy. Biologists have identified factors that may unconsciously influence the expression of jealousy like:
•	Anger towards a person or a situation that is interfering with something you care about.
•	Resenting a friend or a partner when they can’t spend enough time with you(even when a person realizes that they have important affairs to attend to).
•	Difficulty feeling happy for a co-worker when they receive something you wanted or desired.
•	Feelings of dislike toward a new person in a loved one’s life that are hard to explain. For example, a father might have feelings of hostility that stem from jealousy toward his daughter’s fiancé even if the partner she’s chosen is a healthy one.
•	Deep sadness and a hint of anger when thinking about a partner/friend/family (usually in long-term relation) with other people surrounding them. 
...
Jealousy in Relationships: Mild jealousy can be healthy in relationships. It reiterates the fact that an individual cares about his or her partner, values them and does not want to lose them. Jealousy becomes toxic for relationships, however, if left unchecked. Trust is a key component of any healthy, successful relationship. Jealousy breeds suspicion, doubt, and mistrust, which can snowball into pretty intense emotions and behaviours. What began as a partnership of equals can degenerate into an unhappy relationship of guard and jailer.  This type of jealousy stems from the fear of being replaced by someone else in a valued relationship. 
Jealousy related to power and status: This type of jealousy often occurs at a workplace or in school/colleges where the other person achieves the things you also want before you, may it be then promotion or better grades or higher rank in a competition. 
Pathological jealousy: It is a psychological disorder in which a person is preoccupied with the thought that their spouse or sexual partner is being unfaithful without having any real proof, along with socially unacceptable or abnormal behaviour related to these thoughts. The most common cited forms of psychopathology in morbid jealousy are delusions and obsessions. It is considered a subtype of delusional disorder.
