    ...
    <Layout>
      ...
      <div className="container-fluid  py-5">
        ...
        <div className=" col-md col-sm-6 ">
          ...
          <div className="row  row-header display-7  fw-bold align-items-center py-5" style={{
                fontFamily: "American Typewriter", textAlign: "justify",}}>

            <h2> <h2 style={{ color: "rgb(216, 94, 12)" }}>More on the topic:</h2>
            <ul><a href="https://www.youtube.com/watch?v=RgYBTO7r8TQ ">https://www.youtube.com/watch?v=RgYBTO7r8TQ </a></ul>
            <ul><a href="https://www.youtube.com/watch?v=JD4O7ama3o8">https://www.youtube.com/watch?v=JD4O7ama3o8</a></ul>
            </h2>
          </div>
          <div className="cards card-body">
            ...
            >
              ...
              <h3 className="display-7 fw-bold ">The lie goes something like this: When someone else succeeds, it
              ...
              ledger means a negative balance in mine. But, it’s a myth. </h3>
              <h3 className="display-7 fw-bold ">If
              ...
              minds is, “Why do they have ______, and I don’t?” (Fill in the
              blank with success, fame, money, or a million other things.)</h3>
              <h3 className="display-7 fw-bold "> But
              this is the wrong question, and here’s why: It’s based on a
              destructive lie about success and everything else you desire.</h3>
              <h3 className="display-7 fw-bold "> Just
              ...
              <h3 className="display-7 fw-bold ">The issue is that most of us are stuck in a poverty mentality-
              ...
              around. Success breeds success. We can help each other.”</h3>
              <h3 className="display-7 fw-bold "> The
              ...
              take 100% responsibility for your life.</h3>
              <h3 className="display-7 fw-bold "> “Why” questions keep us
              ...
              control is yourself. The sooner you realize it, the better.</h3>
              <h3 className="display-7 fw-bold "> But to
              ...
              the other.</h3>
              <h3 className="display-7 fw-bold "> When we’re jealous of someone, we begin to think of
              ...
              discoveries that help on our own journeys.</h3>
              <h3 className="display-7 fw-bold "> We all have our own
              ...
              <h3 className="display-7 fw-bold ">Jealousy causes us to be inwardly focused. The more we fixate on
              ...
              interests first”. And I can’t argue.</h3>
              <h3 className="display-7 fw-bold "> The only way to defeat
              jealousy is by taking action. You won’t do it by thinking or
              analysing. You have to do something about it.</h3>
              <h3 className="display-7 fw-bold "> Don’t forget that
              ...
              chances you’ll have to live the life you’ll remember.</h3>
              <h3 className="display-7 fw-bold "> So, don’t
              ...
              going to be absolutely gorgeous in the end.</h3>
            </h3>
          </div>
        </div>
      </div>
